...
def barycentric(vertices, point):
    ####
    # Step 1. Project the point onto the subspace

    # case 1: line segment
    # algorithm courtesy of Wikibooks: https://en.wikibooks.org/wiki/Linear_Algebra/Orthogonal_Projection_Onto_a_Line
    if len(vertices) == 2:
        line_vector = subtract(vertices[1], vertices[0])
        proj = project(point, line_vector)
    # case 2: triangle
